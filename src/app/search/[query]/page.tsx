      ...
      <nav style={{
        ...
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
          ...
          <span style={{
            ...
            fontSize: 18, letterSpacing: '-0.5px', color: 'var(--text)',
          }}>
            নিরাপদ
          </span>
        </Link>
        <Link href="/report" style={{
          ...
          color: 'var(--red)', padding: '7px 14px', borderRadius: 8,
      ...
      <main style={{ maxWidth: 680, margin: '0 auto', padding: '32px 20px 80px' }}>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <h1 style={{
            ...
            wordBreak: 'break-all', color: 'var(--text)', lineHeight: 1.3,
          }}>
            {decoded}
          </h1>
        </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              {[
                ...
                { val: entity.bkash_numbers.length, label: 'Linked wallets' },
              ].map(s => (
              ...
              {reports.map(r => (
                <div key={r.id} style={{
                  ...
                  {r.proof_urls.length > 0 && (
                    <p style={{
                      fontSize: 11, color: 'var(--green)', marginTop: 10,
                      display: 'flex', alignItems: 'center', gap: 4,
                    }}>
                      ✓ Proof uploaded
                    </p>
